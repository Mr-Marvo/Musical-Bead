      ...
      <div className="flex flex-col">
        <Slide bottom>
          <div className="flex w-full lg:mt-4 mt-16 font-bold lg:text-[54px] md:text-[44px] leading-relaxed text-3xl justify-center content-center text-center borderedText">
            We transport music from the <br /> past and the present to the
            future
          </div>
        ...
        <div className="flex flex-col lg:w-[60%] lg:ml-8 max-md:mt-8">
          <Slide bottom>
            ...
            <div className="flex font-medium 2xl:text-3xl xl:text-3xl lg:text-2l text-xl text-teal mt-12 leading-relaxed">
              ...
              <br />
              <br />
              Well, in the modern world of instant downloads, music is just
              music. But the thing is…We’re missing the depth and personal
              connections we used to feel with artists. I'm sure you can relate
              but what if I told you that you could reconnect and give your fans
              that same tangible experience?
              <br />
              <br />

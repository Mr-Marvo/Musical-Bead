      ...
      <div className="flex flex-col min-lg:w-[60%] w-full max-md:px-4 max-md:mt-12">
        <Slide bottom>
          <img
            src={Music}
            alt="Music"
            className="absolute right-56 opacity-40"
          />
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-row mt-4">
              <img src={Star} className="w-8 h-8 p-2" alt="Star" />
              <div className="md:text-[23px] text-lg font-bold text-teal">
                PU leather provides an extra layer of protection and makes
                Musical Bead keychains the most stylish way to connect with fans
                worldwide.
              </div>
            </div>
          </div>

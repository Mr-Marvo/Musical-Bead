  ...
  return (
    <div className="flex flex-row gap-3 w-[300px] h-120 my-2 bg-black rounded-xl p-2">
      ...
      <div className="flex flex-col text-white pr-2 pt-2 pb-2">
        ...
        <button className="flex mt-4 border-[1px] border-[#DFAF03] rounded-lg px-1 py-1 text-[16px] font-medium">
          Order Details
        </button>
        <button className="flex mt-4 bg-[#DFAF03] rounded-lg px-1 py-1 text-[18px] font-medium">
          Track Order
        </button>
      </div>
    </div>
